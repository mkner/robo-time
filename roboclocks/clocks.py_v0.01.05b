    ...
    def getTimestampStr(self):
        ...
        if ( self.__class__.__name__ == 'Clock'):
            ...
            if (resz == 'none'):
                ...
                hs + tmsep + ms + tmsep + sc   #mk NEW
                # hs+":"+ms+":"+ sc    
            else:
                tsz =  ys + ddsep + mostr + ddsep + dystr + dtsep + \
                hs + tmsep + ms + tmsep + sc + resep + resz   #mk NEW
                #hs+":"+ms+":"+ sc + resep + resz
        else:
