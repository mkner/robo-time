         ...
         #a=0
            ...
            if (abs(delta_adj) > self._ntp_delta_threshold ):
                ...
                if (was_ntp_ok):
                    ...
                    print()
                    x = m.modf(delta_after)
                    dt_millis = x[0]*1000
                    dt_micros = x[0]*1000000
                    print("delta:",round(delta_after,10),"(fp)")
                    print("delta:",int(dt_millis),"(ms)")
                    print()
    ...
    def _init_ntp_clock(self):
        ...
        # dont use resync too complicated to flag stuff?
            ...
            for i in range(isyncs):
                print()
                print("Synchronization phase #",i+1)
                print()
            ...
            if sync_ok:
                print("Current WorldClock NTP time (UTC):", \
