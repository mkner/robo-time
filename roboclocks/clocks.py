...
class Clock(Object):
    ...
    # def setTimestampCompressed(self):
    #     # make all delimiter/separators ''
    #     # to compress into compact ascii string
    #     self.setTimestampDateSep('')
    #     self.setTimestampSep('')
    ...
    def setTimestampFormat(self,tsformat): 
        ...
        # for variations within whatever spec is being used
            ...
            #mk
            #NEW    v0.1.6
            # all clocks call back up to Clock.getTimestampStr()
            # SystemClock needs this for that
...
class WorldClock(Clock):
    ...
    def getTimestampStr(self):
        ...
        if ( self._timestamp_format == 'iso-local'):
            ...
            # uf = self._cal_utc_offset
            #  if int(uf) != 0: #mk ZERO?! OK wasnt a flag
            ...
            tsz =  ys + ddsep + mostr + ddsep + dystr + dtsep + \
                  ...
                  if (self._timestamp_use_ztail == True):
                    ...
                    tsz =  ys + ddsep + mostr + ddsep + dystr + dtsep + \
                      ...
                      #mk new tmsep
                      tsz =  ys + ddsep + mostr + ddsep + dystr + dtsep + \
                          hs + tmsep + ms + tmsep + sc + resep + resz + "+00:00"
...
##############
    ...
    #     return
        ...
        # today = dystr+"-"+mostr+"-"+ dystr +" "+hs+":"+ms+":"+sc
        # print(today)
  ...
  #   weekday_en = { 0:'Monday',
    ...
    ## KEEP this code, to resue for
    ## iso stuff to check
    #
    #ck on override names
    
    #mk next these
    # def getTimestamp(self):
        
    #     # returns tuple version
    #     return
    ...
    #FALLS BACK TO Clock()
    # falls back to Clock function., yes
